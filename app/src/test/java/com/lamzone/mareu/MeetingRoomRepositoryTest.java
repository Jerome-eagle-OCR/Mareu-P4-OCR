...
public class MeetingRoomRepositoryTest {
    ...
    private final long TEST_MEETING_START_TIME = System.currentTimeMillis();
    private final long TEST_MEETING_DATE = TEST_MEETING_START_TIME + 2880 * 60000; //+48h
    private final long TEST_MEETING_END_TIME = TEST_MEETING_START_TIME + 30 * 60000;//+30mn
    private final List<String> TEST_MEETING_PARTICIPANTS = Arrays.asList("testParticipant1@lamzone.test", "testParticipant2@lamzone.test", "testParticipant3@lamzone.test");

    //TEST_MEETING_ROOM3 is the only meeting room that can host our new TEST_MEETING
    private final Meeting TEST_MEETING1 = new Meeting(TEST_MEETING_ROOM1, TEST_MEETING_SUBJECT, TEST_MEETING_START_TIME - 5 * 60000, TEST_MEETING_END_TIME - 10 * 60000, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING2 = new Meeting(TEST_MEETING_ROOM2, TEST_MEETING_SUBJECT, TEST_MEETING_START_TIME - 30 * 60000, TEST_MEETING_START_TIME - 0, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING3 = new Meeting(TEST_MEETING_ROOM2, TEST_MEETING_SUBJECT, TEST_MEETING_END_TIME - 5 * 60000, TEST_MEETING_END_TIME + 10 * 60000, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING4 = new Meeting(TEST_MEETING_ROOM2, TEST_MEETING_SUBJECT, TEST_MEETING_END_TIME + 0, TEST_MEETING_END_TIME + 15 * 60000, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING5 = new Meeting(TEST_MEETING_ROOM3, TEST_MEETING_SUBJECT, TEST_MEETING_START_TIME - 15 * 60000, TEST_MEETING_START_TIME - 0, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING6 = new Meeting(TEST_MEETING_ROOM3, TEST_MEETING_SUBJECT, TEST_MEETING_START_TIME - 30 * 60000, TEST_MEETING_START_TIME - 15 * 60000, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING7 = new Meeting(TEST_MEETING_ROOM3, TEST_MEETING_SUBJECT, TEST_MEETING_END_TIME + 5 * 60000, TEST_MEETING_END_TIME + 20 * 60000, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING8 = new Meeting(TEST_MEETING_ROOM3, TEST_MEETING_SUBJECT, TEST_MEETING_END_TIME + 20 * 60000, TEST_MEETING_END_TIME + 45 * 60000, TEST_MEETING_PARTICIPANTS);

    public final List<Meeting> TEST_MEETINGS = Arrays.asList(TEST_MEETING2, TEST_MEETING6, TEST_MEETING5, TEST_MEETING1, TEST_MEETING3, TEST_MEETING4, TEST_MEETING7, TEST_MEETING8);
