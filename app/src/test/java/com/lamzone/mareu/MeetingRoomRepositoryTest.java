...
public class MeetingRoomRepositoryTest {
    ...
    private final long TEST_MEETING_START_TIME = System.currentTimeMillis() / 60000; //Current time in minutes
    ...
    private final Meeting TEST_MEETING1 = new Meeting(TEST_MEETING_ROOM1, TEST_MEETING_SUBJECT, "Any day", TEST_MEETING_START_TIME - 5, TEST_MEETING_END_TIME - 10, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING2 = new Meeting(TEST_MEETING_ROOM2, TEST_MEETING_SUBJECT, "Any day", TEST_MEETING_START_TIME - 30, TEST_MEETING_START_TIME - 0, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING4 = new Meeting(TEST_MEETING_ROOM2, TEST_MEETING_SUBJECT, "Any day", TEST_MEETING_END_TIME - 5, TEST_MEETING_END_TIME + 10, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING3 = new Meeting(TEST_MEETING_ROOM2, TEST_MEETING_SUBJECT, "Any day", TEST_MEETING_END_TIME + 0, TEST_MEETING_END_TIME + 15, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING5 = new Meeting(TEST_MEETING_ROOM3, TEST_MEETING_SUBJECT, "Any day", TEST_MEETING_START_TIME - 15, TEST_MEETING_START_TIME - 0, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING6 = new Meeting(TEST_MEETING_ROOM3, TEST_MEETING_SUBJECT, "Any day", TEST_MEETING_START_TIME - 30, TEST_MEETING_START_TIME - 15, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING7 = new Meeting(TEST_MEETING_ROOM3, TEST_MEETING_SUBJECT, "Any day", TEST_MEETING_END_TIME + 5, TEST_MEETING_END_TIME + 20, TEST_MEETING_PARTICIPANTS);
    private final Meeting TEST_MEETING8 = new Meeting(TEST_MEETING_ROOM3, TEST_MEETING_SUBJECT, "Any day", TEST_MEETING_END_TIME + 20, TEST_MEETING_END_TIME + 45, TEST_MEETING_PARTICIPANTS);
    ...
    public void scheduleMeetingWithSuccess() {
        ...
        //Then : the new meeting is scheduled (added to meetings list)
